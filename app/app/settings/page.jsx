...
export default function SriLankaSettingsPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-slate-50/50 font-sans text-slate-900 pb-32"
    >
      {/* 1. PAGE HEADER */}
          ...
          <nav className="sticky top-24 self-start space-y-1 animate-section">
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-xl transition-all duration-300 ${activeTab === item.id ? "bg-white text-indigo-600 shadow-lg shadow-indigo-100 ring-1 ring-indigo-50 translate-x-2" : "text-slate-500 hover:bg-slate-100 hover:text-slate-900"}`}
              >
                <item.icon
                  className={`w-4 h-4 ${activeTab === item.id ? "text-indigo-600" : "text-slate-400"}`}
                />
                {item.label}
              </button>
            ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:bg-white focus:border-indigo-500 outline-none transition-all font-medium"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-700 uppercase">
          ...
          <section id="payments" className="animate-section scroll-mt-32">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-5 rounded-xl border border-indigo-200 bg-indigo-50/20">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white rounded-lg border border-slate-100 flex items-center justify-center shadow-sm text-green-600 font-bold">
                      COD
                    </div>
                    <div>
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:bg-emerald-500 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={() => setHasChanges(true)}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:bg-white focus:border-green-500 outline-none transition-all font-medium font-mono"
                />
              </div>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="p-5 border border-slate-200 rounded-xl bg-slate-50/50">
                    <div className="space-y-4">
                      <div>
                        ...
                        <select className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2.5 text-sm font-medium outline-none focus:ring-2 focus:ring-amber-500/20">
                          <option>Products Inventory</option>
                          <option>Orders (Last 30 Days)</option>
                          <option>All Orders (History)</option>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <label className="flex items-center gap-2 px-3 py-2 border border-slate-200 bg-white rounded-lg cursor-pointer hover:border-amber-500 transition-colors">
                            <input
                              type="radio"
                              name="format"
                      ...
                      <button className="w-full py-2.5 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-bold text-sm rounded-lg flex items-center justify-center gap-2 transition-all">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="font-bold text-slate-900 flex items-center gap-2">
                      <Upload className="w-4 h-4 text-slate-500" /> Import Data
                    </h3>
                  ...
                  <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50 p-6 flex flex-col items-center justify-center text-center hover:bg-slate-100 transition-colors cursor-pointer group">
                    <input
                      type="file"
              ...
              <div className="grid grid-cols-1 gap-3">
                {team.map((member) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`text-[10px] font-bold uppercase px-2 py-1 rounded-md ${member.role === "Owner" ? "bg-indigo-100 text-indigo-700" : "bg-slate-100 text-slate-600"}`}
                      >
                        {member.role}
                      </span>
                    </div>
      ...
      >
        <div className="bg-slate-900 text-white p-4 rounded-2xl shadow-2xl flex items-center justify-between border border-slate-700/50 backdrop-blur-xl">
          <div className="flex items-center gap-3">
